...
// classes that inherit from this should not be deconstructed until the end of
// the program, else a segault will occur
//

namespace engine {
// DO NOT TYPE MONOBEHAVIOUR IN A COMMENT AFTER CREATING AN OBJECT OF THIS CLASS
class MonoBehaviour {
...
public:
  ...
  MonoBehaviour() { process_updates.push_back(this); }
};
} // namespace engine
